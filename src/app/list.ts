export const listData = [
  ...
  {
    id: 5,
    materia: 'Projeto de Encontrabilidade',
    dia: 'Segunda-feira',
    horario: '19h às 22h30',
    totalAulas: 80,
    ementa:
    ...
    objetivo:
      'Explorar estratégias que direcionam o tráfego para um site, ajudam os usuários a encontrar conteúdo dentro de um site e encorajam consultas de retorno. Discutir os Métodos de Otimização de Search Engine (SEO), estratégias de marketing, análise de tráfego e teoria em torno comportamento de busca.',
  },
  {
    id: 6,
